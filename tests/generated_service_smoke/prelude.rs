...
pub(crate) use larksuite_oapi_sdk_rs::service::{
    ...
    corehr::v1::{
        AddEnumOptionCommonDataMetaDataReqBody, Company, EnumFieldOption,
        GetDepartmentQuery as GetCorehrDepartmentQuery, GetEmployeeQuery as GetCorehrEmployeeQuery,
        JobLevel, ListCompanyQuery as ListCorehrCompanyQuery,
        ListContractQuery as ListCorehrContractQuery,
        ...
        ListWorkingHoursTypeQuery as ListCorehrWorkingHoursTypeQuery, Name,
        RemoveRoleAssignAuthorizationQuery, SearchOffboardingQuery as SearchCorehrOffboardingQuery,
    ...
    docx::v1::{
        ...
        BatchUpdateChatAnnouncementBlockQuery, BatchUpdateChatAnnouncementBlockReqBody,
        BatchUpdateDocumentBlockQuery, Block as DocxBlock, ConvertDocumentQuery,
        ConvertDocumentReqBody, CreateBlockReqBody, CreateChatAnnouncementBlockChildrenQuery,
        CreateChatAnnouncementBlockChildrenReqBody, CreateDocumentBlockDescendantQuery,
        CreateDocumentBlockDescendantReqBody, CreateDocumentBlockQuery, CreateDocumentQuery,
    ...
    hire::v1::{
        AddToFolderTalentReqBody, BatchGetIdTalentReqBody,
        ...
        ListWebsiteQuery as ListHireWebsiteQuery, OnboardStatusTalentReqBody, OpenJobReqBody,
        QueryAgencyQuery as QueryHireAgencyQuery, QueryLocationQuery as QueryHireLocationQuery,
        ...
        SearchWebsiteJobPostQuery as SearchHireWebsiteJobPostQuery, TagTalentReqBody,
    },
    hire::v2::{
    ...
    okr::v1::{
        BatchGetOkrQuery, CreatePeriodQuery as CreateOkrPeriodQuery, CreatePeriodReqBody,
        CreateProgressRecordQuery, CreateProgressRecordReqBody, DeleteProgressRecordQuery,
        GetProgressRecordQuery, GetUserOkrQuery, ListPeriodQuery as ListOkrPeriodQuery,
        ListPeriodRuleQuery, PatchPeriodQuery as PatchOkrPeriodQuery, PatchPeriodReqBody,
        ProgressRateNew, QueryReviewQuery, UpdateProgressRecordQuery, UpdateProgressRecordReqBody,
    ...
    vc::{
        ApplyReserveQuery, ApplyReserveReqBody, CreateRoomQuery as CreateVcRoomQuery,
        CreateRoomReqBody, GetActiveMeetingReserveQuery, GetMeetingListQuery,
        GetParticipantListQuery, GetParticipantQualityListQuery, GetReserveQuery,
        GetResourceReservationListQuery, GetRoomQuery as GetVcRoomQuery, GetTopUserReportQuery,
        ListAlertQuery, ListMeetingByNoQuery, ListRoomQuery as ListVcRoomQuery, MgetRoomQuery,
        MgetRoomReqBody, RoomConfigQuery, SearchRoomQuery, SearchRoomReqBody, SetRoomConfigQuery,
        SetRoomConfigReqBody, UpdateReserveQuery, UpdateReserveReqBody,
