...
mod helpdesk_ticket;
#[path = "generated_service_smoke/hire/action_response.rs"]
mod hire_action_response;
...
mod hire_talent;
#[path = "generated_service_smoke/hire/talent_exam_write.rs"]
mod hire_talent_exam_write;
