...
use larksuite_oapi_sdk_rs::service::{
    ...
    application::v6::{
        ...
        OverviewApplicationAppUsageQuery, PatchApplicationAppVersionQuery,
        PatchApplicationContactsRangeQuery, PatchApplicationFeedbackQuery, PatchApplicationQuery,
        SetAppBadgeQuery, UnderauditlistApplicationQuery, UpdateApplicationCollaboratorsQuery,
        UpdateApplicationManagementQuery, UpdateApplicationOwnerQuery,
    },
    approval::v4::{
    ...
    cardkit::v1::{
        BatchUpdateCardQuery as BatchUpdateCardkitCardQuery,
        ContentCardElementQuery as ContentCardkitElementQuery,
        CreateCardElementQuery as CreateCardkitElementQuery,
        CreateCardInstanceQuery as CreateCardkitInstanceQuery, CreateCardInstanceReqBody,
        CreateCardQuery as CreateCardkitCardQuery,
        DeleteCardElementQuery as DeleteCardkitElementQuery,
        IdConvertCardQuery as IdConvertCardkitCardQuery,
        PatchCardElementQuery as PatchCardkitElementQuery,
        SettingsCardQuery as SettingsCardkitCardQuery,
        UpdateCardElementQuery as UpdateCardkitElementQuery,
        UpdateCardInstanceQuery as UpdateCardkitInstanceQuery, UpdateCardInstanceReqBody,
        UpdateCardQuery as UpdateCardkitCardQuery,
    },
    common::PageQuery,
    contact::v3::{
    ...
    im::v2::{
        ...
        CreateBizEntityTagRelationV2Query, CreateTagV2Query, DeleteAppFeedCardBatchV2Query,
        GetBizEntityTagRelationV2Query, PatchFeedCardV2Query, PatchTagV2Query,
        UpdateAppFeedCardBatchV2Query, UpdateBizEntityTagRelationV2Query, UpdateChatButtonV2Query,
    },
    lingo::v1::{
    ...
    search::v2::{
        ...
        DeleteDataSourceSchemaQuery, DeleteSchemaQuery, GetDataRecordQuery, GetDataSourceQuery,
        GetDataSourceSchemaQuery, GetSchemaQuery, ListDataSourceQuery, PatchDataSourceQuery,
        PatchDataSourceReqBody, PatchDataSourceSchemaQuery, PatchSchemaQuery, PatchSchemaReqBody,
