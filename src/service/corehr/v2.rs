...
// approval_groups
impl_resp!(GetApprovalGroupsV2Resp, serde_json::Value);
impl_resp!(OpenQueryDeptChangeApprovalGroupsV2Resp, serde_json::Value);
impl_resp!(OpenQueryJobChangeApprovalGroupsV2Resp, serde_json::Value);
impl_resp!(
    OpenQueryPositionChangeApprovalGroupsV2Resp,
    serde_json::Value
);
// approver
impl_resp!(ListApproverV2Resp, ListData);
// basic_info
impl_resp!(SearchBankV2Resp, ListData);
impl_resp!(SearchBankBranchV2Resp, ListData);
impl_resp!(SearchCityV2Resp, ListData);
impl_resp!(SearchCountryRegionV2Resp, ListData);
impl_resp!(SearchCountryRegionSubdivisionV2Resp, ListData);
impl_resp!(SearchCurrencyV2Resp, ListData);
impl_resp!(SearchDistrictV2Resp, ListData);
impl_resp!(SearchLanguageV2Resp, ListData);
impl_resp!(SearchNationalityV2Resp, ListData);
impl_resp!(SearchTimeZoneV2Resp, ListData);
// bp
impl_resp!(GetBpByDepartmentV2Resp, serde_json::Value);
impl_resp!(ListBpV2Resp, ListData);
// company
impl_resp!(ActiveCompanyV2Resp, serde_json::Value);
impl_resp!(BatchGetCompanyV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeCompanyV2Resp, serde_json::Value);
// contract
impl_resp!(SearchContractV2Resp, ListData);
// cost_allocation
impl_resp!(BatchQueryCostAllocationV2Resp, serde_json::Value);
impl_resp!(CreateVersionCostAllocationV2Resp, serde_json::Value);
impl_resp!(RemoveVersionCostAllocationV2Resp, serde_json::Value);
impl_resp!(UpdateVersionCostAllocationV2Resp, serde_json::Value);
// cost_center
impl_resp!(CreateCostCenterV2Resp, serde_json::Value);
impl_resp!(DeleteCostCenterV2Resp, ());
impl_resp!(PatchCostCenterV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeCostCenterV2Resp, serde_json::Value);
impl_resp!(SearchCostCenterV2Resp, ListData);
impl_resp!(CreateCostCenterVersionV2Resp, serde_json::Value);
impl_resp!(DeleteCostCenterVersionV2Resp, ());
impl_resp!(PatchCostCenterVersionV2Resp, serde_json::Value);
// custom_org
impl_resp!(ActiveCustomOrgV2Resp, serde_json::Value);
impl_resp!(CreateCustomOrgV2Resp, serde_json::Value);
impl_resp!(DeleteOrgCustomOrgV2Resp, serde_json::Value);
impl_resp!(PatchCustomOrgV2Resp, serde_json::Value);
impl_resp!(QueryCustomOrgV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeCustomOrgV2Resp, serde_json::Value);
impl_resp!(UpdateRuleCustomOrgV2Resp, serde_json::Value);
// default_cost_center
impl_resp!(BatchQueryDefaultCostCenterV2Resp, serde_json::Value);
impl_resp!(CreateVersionDefaultCostCenterV2Resp, serde_json::Value);
impl_resp!(RemoveVersionDefaultCostCenterV2Resp, serde_json::Value);
impl_resp!(UpdateVersionDefaultCostCenterV2Resp, serde_json::Value);
// department
impl_resp!(BatchGetDepartmentV2Resp, serde_json::Value);
impl_resp!(DeleteDepartmentV2Resp, ());
impl_resp!(ParentsDepartmentV2Resp, serde_json::Value);
impl_resp!(PatchDepartmentV2Resp, serde_json::Value);
impl_resp!(QueryMultiTimelineDepartmentV2Resp, serde_json::Value);
impl_resp!(QueryOperationLogsDepartmentV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeDepartmentV2Resp, serde_json::Value);
impl_resp!(QueryTimelineDepartmentV2Resp, serde_json::Value);
impl_resp!(SearchDepartmentV2Resp, ListData);
impl_resp!(TreeDepartmentV2Resp, serde_json::Value);
// draft
impl_resp!(GetDraftV2Resp, serde_json::Value);
// employee
impl_resp!(BatchGetEmployeeV2Resp, serde_json::Value);
impl_resp!(CreateEmployeeV2Resp, serde_json::Value);
impl_resp!(SearchEmployeeV2Resp, ListData);
// employees_additional_job
impl_resp!(BatchEmployeesAdditionalJobV2Resp, serde_json::Value);
impl_resp!(CreateEmployeesAdditionalJobV2Resp, serde_json::Value);
impl_resp!(DeleteEmployeesAdditionalJobV2Resp, ());
impl_resp!(PatchEmployeesAdditionalJobV2Resp, serde_json::Value);
// employees_bp
impl_resp!(BatchGetEmployeesBpV2Resp, serde_json::Value);
// employees_international_assignment
impl_resp!(CreateEmployeesIntlAssignmentV2Resp, serde_json::Value);
impl_resp!(DeleteEmployeesIntlAssignmentV2Resp, ());
impl_resp!(ListEmployeesIntlAssignmentV2Resp, ListData);
impl_resp!(PatchEmployeesIntlAssignmentV2Resp, serde_json::Value);
// employees_job_data
impl_resp!(BatchGetEmployeesJobDataV2Resp, serde_json::Value);
impl_resp!(QueryEmployeesJobDataV2Resp, serde_json::Value);
// enum
impl_resp!(SearchEnumV2Resp, ListData);
// job
impl_resp!(BatchGetJobV2Resp, serde_json::Value);
impl_resp!(GetJobV2Resp, serde_json::Value);
impl_resp!(ListJobV2Resp, ListData);
impl_resp!(QueryMultiTimelineJobV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeJobV2Resp, serde_json::Value);
// job_change
impl_resp!(CreateJobChangeV2Resp, serde_json::Value);
impl_resp!(RevokeJobChangeV2Resp, serde_json::Value);
impl_resp!(SearchJobChangeV2Resp, ListData);
// job_family
impl_resp!(BatchGetJobFamilyV2Resp, serde_json::Value);
impl_resp!(QueryMultiTimelineJobFamilyV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeJobFamilyV2Resp, serde_json::Value);
// job_grade
impl_resp!(CreateJobGradeV2Resp, serde_json::Value);
impl_resp!(DeleteJobGradeV2Resp, ());
impl_resp!(PatchJobGradeV2Resp, serde_json::Value);
impl_resp!(QueryJobGradeV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeJobGradeV2Resp, serde_json::Value);
// job_level
impl_resp!(BatchGetJobLevelV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeJobLevelV2Resp, serde_json::Value);
// location
impl_resp!(ActiveLocationV2Resp, serde_json::Value);
impl_resp!(BatchGetLocationV2Resp, serde_json::Value);
impl_resp!(PatchLocationV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangeLocationV2Resp, serde_json::Value);
impl_resp!(CreateLocationAddressV2Resp, serde_json::Value);
impl_resp!(DeleteLocationAddressV2Resp, ());
impl_resp!(PatchLocationAddressV2Resp, serde_json::Value);
// offboarding
impl_resp!(EditOffboardingV2Resp, serde_json::Value);
impl_resp!(RevokeOffboardingV2Resp, serde_json::Value);
impl_resp!(SubmitOffboardingV2Resp, serde_json::Value);
// pathway
impl_resp!(ActivePathwayV2Resp, serde_json::Value);
impl_resp!(BatchGetPathwayV2Resp, serde_json::Value);
impl_resp!(CreatePathwayV2Resp, serde_json::Value);
impl_resp!(DeletePathwayV2Resp, ());
impl_resp!(PatchPathwayV2Resp, serde_json::Value);
// person
impl_resp!(CreatePersonV2Resp, serde_json::Value);
impl_resp!(PatchPersonV2Resp, serde_json::Value);
// position
impl_resp!(ActivePositionV2Resp, serde_json::Value);
impl_resp!(CreatePositionV2Resp, serde_json::Value);
impl_resp!(DelPositionV2Resp, serde_json::Value);
impl_resp!(PatchPositionV2Resp, serde_json::Value);
impl_resp!(QueryPositionV2Resp, serde_json::Value);
impl_resp!(QueryRecentChangePositionV2Resp, serde_json::Value);
// pre_hire
impl_resp!(CompletePreHireV2Resp, serde_json::Value);
impl_resp!(CreatePreHireV2Resp, serde_json::Value);
impl_resp!(DeletePreHireV2Resp, ());
impl_resp!(PatchPreHireV2Resp, serde_json::Value);
impl_resp!(QueryPreHireV2Resp, serde_json::Value);
impl_resp!(RestoreFlowInstancePreHireV2Resp, serde_json::Value);
impl_resp!(SearchPreHireV2Resp, ListData);
impl_resp!(TransformOnboardingTaskPreHireV2Resp, serde_json::Value);
impl_resp!(TransitTaskPreHireV2Resp, serde_json::Value);
impl_resp!(WithdrawOnboardingPreHireV2Resp, serde_json::Value);
// probation
impl_resp!(EnableDisableAssessmentProbationV2Resp, serde_json::Value);
impl_resp!(SearchProbationV2Resp, ListData);
impl_resp!(SubmitProbationV2Resp, serde_json::Value);
impl_resp!(WithdrawProbationV2Resp, serde_json::Value);
impl_resp!(CreateProbationAssessmentV2Resp, serde_json::Value);
impl_resp!(DeleteProbationAssessmentV2Resp, ());
impl_resp!(PatchProbationAssessmentV2Resp, serde_json::Value);
// process
impl_resp!(FlowVariableDataProcessV2Resp, serde_json::Value);
impl_resp!(GetProcessV2Resp, serde_json::Value);
impl_resp!(ListProcessV2Resp, ListData);
impl_resp!(UpdateProcessApproverV2Resp, serde_json::Value);
impl_resp!(UpdateProcessExtraV2Resp, serde_json::Value);
impl_resp!(GetProcessFormVariableDataV2Resp, serde_json::Value);
impl_resp!(UpdateProcessTransferV2Resp, serde_json::Value);
impl_resp!(UpdateProcessRevokeV2Resp, serde_json::Value);
impl_resp!(UpdateProcessWithdrawV2Resp, serde_json::Value);
// report_detail_row
impl_resp!(BatchDeleteReportDetailRowV2Resp, serde_json::Value);
impl_resp!(BatchSaveReportDetailRowV2Resp, serde_json::Value);
// signature_file
impl_resp!(DownloadSignatureFileV2Resp, serde_json::Value);
impl_resp!(ListSignatureFileV2Resp, ListData);
impl_resp!(ListByBizIdSignatureFileV2Resp, ListData);
impl_resp!(QuerySignatureFileV2Resp, serde_json::Value);
impl_resp!(TerminateSignatureFileV2Resp, serde_json::Value);
impl_resp!(ListByFileIdSignatureNodeV2Resp, ListData);
impl_resp!(SearchSignatureTemplateV2Resp, ListData);
impl_resp!(ListSignatureTemplateInfoWithThumbnailV2Resp, ListData);
// workforce_plan
impl_resp!(ListWorkforcePlanV2Resp, ListData);
impl_resp!(BatchWorkforcePlanDetailV2Resp, serde_json::Value);
impl_resp!(BatchV2WorkforcePlanDetailV2Resp, serde_json::Value);
impl_resp!(BatchDeleteWorkforcePlanDetailRowV2Resp, serde_json::Value);
impl_resp!(BatchSaveWorkforcePlanDetailRowV2Resp, serde_json::Value);
